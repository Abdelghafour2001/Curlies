            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Ajouter Post</a>
                        <a class="collapse-item" href="cards.html">Afficher les Posts</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <i class="fas fa-table"></i> Ajouter Categories<a href="{{url('admin/category')}}" class="float-right btn btn-sm " style="background-color:rgb(234,115,143);color:white;">Afficher tout</a>
                    </div>
                    <div class="card-body">
...
<tr>
                                    <th>Image</th>
                                    <td>
                                        <p class='my-2'><img src="{{ asset('imgs/'.$data->image)}}" style='width: 60px;' /></p>
